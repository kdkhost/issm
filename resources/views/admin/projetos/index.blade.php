            ...
            <tr class="hover:bg-gray-50 transition-colors">
                ...
                <td class="px-4 py-3 whitespace-nowrap">
                    <div class="flex items-center gap-1">
                        ...
                        <form method="POST" action="{{ route("admin.projetos.destroy", $project) }}">@csrf @method("DELETE")<button type="submit" data-confirm="Excluir este projeto?" class="text-red-600 hover:text-red-800 text-sm font-medium px-1">Excluir</button></form>
                    </div>
                </td>
            </tr>
