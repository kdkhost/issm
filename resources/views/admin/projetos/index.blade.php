            ...
            <tr>
                ...
                <td>
                    <div class="project-actions" style="justify-content: flex-end;">
                        ...
                        <form method="POST" action="{{ route("admin.projetos.destroy", $project) }}" onsubmit="return confirm('Tem certeza que deseja excluir este projeto?')" style="display: inline;">
                            @csrf
                            @method("DELETE")
                            <button type="submit" class="action-btn delete" title="Excluir projeto">
