                    ...
                    <div class="cfg-card-body">
                        <div class="cfg-grid">
                            ...
                            <div class="{{ $wide ? 'cfg-wide' : '' }}">
                                ...
                                @elseif(in_array($s->key,['partners_carousel_speed','partners_logo_height','partners_carousel_per_view']))
                                <div class="cfg-num-wrap">
                                    <input type="number" name="{{ $s->key }}" value="{{ $s->value }}" class="cfg-num-input">
                                    <span class="cfg-num-unit">@if(str_contains($s->key,'_speed'))ms @elseif(str_contains($s->key,'_height'))px @else un @endif</span>
                                </div>
