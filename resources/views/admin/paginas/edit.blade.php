...
<form id="pageForm" method="POST" action="{{ route('admin.paginas.update', $page) }}" enctype="multipart/form-data">
    @csrf @method('PUT')
    ...
    <div class="grid grid-cols-1 xl:grid-cols-5 gap-5">
        ...
        <div class="xl:col-span-3 space-y-4">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-5 space-y-4 border border-gray-100 dark:border-gray-700">
                ...
                <div>
                    ...
                    <input id="ptitle" type="text" name="title" value="{{ old('title', $page->title) }}" required class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-green-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Conteudo *</label>
                    <textarea name="content" rows="10" required class="wysiwyg w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-green-500">{{ old('content', $page->content) }}</textarea>
                </div>
                <div class="flex items-center gap-6">
                    <div class="flex items-center gap-2"><input type="checkbox" name="active" value="1" id="active" {{ $page->active ? 'checked' : '' }} class="w-4 h-4 text-green-600 rounded"><label for="active" class="text-sm font-medium text-gray-700 dark:text-gray-300">Ativo</label></div>
                    <div class="flex items-center gap-2"><input type="checkbox" name="show_in_menu" value="1" id="show_in_menu" {{ $page->show_in_menu ? 'checked' : '' }} class="w-4 h-4 text-green-600 rounded"><label for="show_in_menu" class="text-sm font-medium text-gray-700 dark:text-gray-300">Exibir no Menu</label></div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-5 space-y-4 border border-gray-100 dark:border-gray-700">
                ...
                <div>
                    ...
                    <input id="mt" type="text" name="meta_title" value="{{ old('meta_title', $page->meta_title) }}" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-green-500">
                </div>
                <div>
                    ...
                    <textarea id="md" name="meta_description" rows="3" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-green-500 resize-none">{{ old('meta_description', $page->meta_description) }}</textarea>
                </div>
                <div>
                    ...
                    <input id="st" name="seo_tags" type="text" value="{{ old('seo_tags', $page->seo_tags) }}" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-green-500" placeholder="#issm, #meioambiente, #sustentabilidade, #ods2030, #floresta, #preservacao">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-5 space-y-4 border border-gray-100 dark:border-gray-700">
                ...
                <div>
                    ...
                    <input id="ot" type="text" name="og_title" value="{{ old('og_title', $page->og_title) }}" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-green-500">
                </div>
                <div>
                    ...
                    <textarea id="od" name="og_description" rows="2" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-green-500 resize-none">{{ old('og_description', $page->og_description) }}</textarea>
                </div>
                <div>
                    <label class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 block">OG Image</label>
                    <input id="oi" type="text" name="og_image" value="{{ old('og_image', $page->og_image) }}" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-green-500" placeholder="media/banners/imagem.jpg">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-5 space-y-4 border border-gray-100 dark:border-gray-700">
                ...
                <div>
                    ...
                    <input id="cu" type="url" name="canonical_url" value="{{ old('canonical_url', $page->canonical_url ?? route('pages.show', $page->slug)) }}" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-green-500">
                </div>
                <div>
                    ...
                    <select id="rm" name="robots_meta" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-green-500">
                        <option value="index, follow" {{ old('robots_meta', $page->robots_meta ?? 'index, follow') == 'index, follow' ? 'selected' : '' }}>index, follow</option>
                        <option value="index, nofollow" {{ old('robots_meta', $page->robots_meta ?? '') == 'index, nofollow' ? 'selected' : '' }}>index, nofollow</option>
                        <option value="noindex, follow" {{ old('robots_meta', $page->robots_meta ?? '') == 'noindex, follow' ? 'selected' : '' }}>noindex, follow</option>
                        <option value="noindex, nofollow" {{ old('robots_meta', $page->robots_meta ?? '') == 'noindex, nofollow' ? 'selected' : '' }}>noindex, nofollow</option>
                    </select>
                </div>
            </div>
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="submit" class="bg-green-700 text-white px-6 py-2 rounded-lg hover:bg-green-800 font-medium text-sm transition-colors">Atualizar</button>
            </div>
        </div>
        ...
        <div class="xl:col-span-2 space-y-4">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 border border-gray-100 dark:border-gray-700">
                ...
                <div class="font-sans">
                    <div id="pgt" class="text-[#1a0dab] dark:text-[#8ab4f8] text-base leading-tight truncate hover:underline cursor-pointer">{{ $page->meta_title ?: $page->title ?: 'Titulo' }}</div>
                    <div id="pgu" class="text-xs text-[#006621] dark:text-[#34a853] mt-0.5">{{ url('/') }}/pagina/{{ $page->slug }}</div>
                    <p id="pgd" class="text-sm text-[#4d5156] dark:text-[#bdc1c6] leading-snug mt-1 line-clamp-2">{{ $page->meta_description ?: 'Descricao...' }}</p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 border border-gray-100 dark:border-gray-700">
                ...
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                    <div id="pfi" class="bg-gray-200 dark:bg-gray-700 h-28 bg-cover bg-center" style="background-image: url('{{ $page->og_image ? asset('media/' . $page->og_image) : asset('media/' . \App\Models\Setting::get('og_image', 'logo.png')) }}')"></div>
                    <div class="p-3 bg-white dark:bg-gray-900">
                        ...
                        <h5 id="pft" class="text-sm font-bold text-gray-900 dark:text-gray-100 truncate mt-0.5">{{ $page->og_title ?: $page->meta_title ?: $page->title ?: 'Titulo' }}</h5>
                        <p id="pfd" class="text-xs text-gray-500 dark:text-gray-400 leading-snug mt-0.5 line-clamp-2">{{ $page->og_description ?: $page->meta_description ?: 'Descricao...' }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 border border-gray-100 dark:border-gray-700">
                ...
                <div class="flex gap-3 bg-[#e1ffc7] dark:bg-[#1a2e1a] p-3 rounded-lg rounded-tl-none">
                    <div id="pwi" class="w-12 h-12 rounded bg-gray-300 dark:bg-gray-600 bg-cover bg-center shrink-0" style="background-image: url('{{ $page->og_image ? asset('media/' . $page->og_image) : asset('media/' . \App\Models\Setting::get('og_image', 'logo.png')) }}')"></div>
                    <div class="min-w-0">
                        <p id="pwt" class="text-sm font-medium text-gray-900 dark:text-gray-100 truncate">{{ $page->og_title ?: $page->meta_title ?: $page->title ?: 'Titulo' }}</p>
                        <p id="pwd" class="text-xs text-gray-600 dark:text-gray-300 line-clamp-2">{{ $page->og_description ?: $page->meta_description ?: 'Descricao...' }}</p>
...
(function() {
    const d = document;
    const el = {
        mt: d.getElementById('mt'), md: d.getElementById('md'), st: d.getElementById('st'),
    ...
    const base = '{{ url('/') }}', defImg = '{{ asset("media/" . \App\Models\Setting::get("og_image", "logo.png")) }}', title = '{{ $page->title }}', slug = '{{ $page->slug }}';
    ...
    function score() {
        ...
        const od = el.od.value.trim(), oi = el.oi.value.trim(), st = el.st.value.trim(), cu = el.cu.value.trim(), rm = el.rm.value.trim();
    ...
    ['input', 'change', 'keyup'].forEach(e => {
        ...
        el.oi.addEventListener(e, run); el.st.addEventListener(e, run); el.cu.addEventListener(e, run); el.rm.addEventListener(e, run);
    });
    run();
})();
</script>
