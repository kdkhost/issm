...
<div class="max-w-3xl">
    <form method="POST" action="{{ route("admin.paginas.store") }}" enctype="multipart/form-data">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 space-y-4">
            ...
            <div><label class="block text-sm font-medium text-gray-700 mb-1">Meta Title</label><input type="text" name="meta_title" value="{{ old("meta_title") }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"></div>
            <div><label class="block text-sm font-medium text-gray-700 mb-1">Meta Description</label><textarea name="meta_description" rows="2" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">{{ old("meta_description") }}</textarea></div>
