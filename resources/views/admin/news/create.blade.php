...
@section("content")
<div class="max-w-5xl">
    <form method="POST" action="{{ route("admin.noticias.store") }}" enctype="multipart/form-data" id="newsForm">
        @csrf
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 space-y-5">
                <div class="bg-white rounded-xl shadow-sm p-6 space-y-4">
                    ...
                    <div><label class="block text-sm font-medium text-gray-700 mb-1">Conteúdo *</label><textarea name="content" id="content" rows="12" required class="wysiwyg w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">{{ old("content") }}</textarea></div>
                </div>
                <div class="bg-white rounded-xl shadow-sm p-6 space-y-4">
                    ...
                    <div><label class="block text-sm font-medium text-gray-700 mb-1">Meta Título</label><input type="text" name="meta_title" id="meta_title" value="{{ old("meta_title") }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="SEO title (padrão: título da notícia)"></div>
                    ...
                    <div><label class="block text-sm font-medium text-gray-700 mb-1">OG Imagem</label><input type="file" name="og_image" id="og_image" accept="image/*" class="w-full text-sm text-gray-600"><p class="text-xs text-gray-400 mt-1">Imagem para compartilhamento social (1200x630px). Padrão: imagem da notícia.</p></div>
                </div>
            </div>
            <div class="space-y-5">
                <div class="bg-white rounded-xl shadow-sm p-6 space-y-4">
                    ...
                    <div id="seoPreview">
                        <div class="mb-4">
                            ...
                            <div class="bg-white border border-gray-200 rounded-lg p-3 text-sm">
                                <p class="text-[#1a0dab] text-base font-medium leading-tight truncate" id="googleTitle">Título da notícia</p>
                                <p class="text-[#006621] text-xs leading-tight truncate">https://issm.org.br/noticias/url-da-noticia</p>
                                <p class="text-[#545454] text-xs leading-tight mt-0.5 line-clamp-2" id="googleDesc">Descrição da notícia aparecerá aqui...</p>
                            </div>
                        </div>
                        <div class="mb-4">
