...
<form method="POST" action="{{ route('admin.cms-public-pages.update', $page) }}">
    ...
    <div class="bg-white rounded-xl shadow-sm mb-6 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100 bg-gray-50">
            <h3 class="font-bold text-gray-800">Configuracoes do Banner</h3>
            <p class="text-xs text-gray-500">Secao: hero</p>
        </div>
        <div class="p-6 space-y-5">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Titulo do Banner</label>
                    <input type="text" name="hero[title]" value="{{ $heroVal('title') }}" placeholder="Ex: Nossos Projetos">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Palavra em Destaque <small class="text-gray-400 font-normal">(dentro do titulo)</small></label>
                    <input type="text" name="hero[title_highlight]" value="{{ $heroVal('title_highlight') }}" placeholder="Ex: Projetos">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Cor da Palavra Destacada</label>
                    <div class="flex items-center gap-2">
                        ...
                        <input type="text" name="hero[title_highlight_color]" value="{{ $heroVal('title_highlight_color', '#86efac') }}" class="flex-1" placeholder="#86efac">
                    </div>
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Cor do Breadcrumb</label>
                    <div class="flex items-center gap-2">
                        ...
                        <input type="text" name="hero[breadcrumb_color]" value="{{ $heroVal('breadcrumb_color', '#86efac') }}" class="flex-1" placeholder="#86efac">
                    </div>
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Cor do Subtitulo</label>
                    <div class="flex items-center gap-2">
                        ...
                        <input type="text" name="hero[subtitle_color]" value="{{ $heroVal('subtitle_color', '#bbf7d0') }}" class="flex-1" placeholder="#bbf7d0">
                    </div>
                </div>
            </div>
            <div class="border-t border-gray-100 pt-4">
                <label class="block text-sm font-semibold text-gray-700 mb-2">Gradiente do Fundo</label>
                <div class="flex items-center gap-3 flex-wrap">
                    <div class="flex items-center gap-2">
                        ...
                        <input type="text" name="hero[gradient_start]" value="{{ $heroVal('gradient_start', '#166534') }}" class="w-28" placeholder="#166534">
                    </div>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <input type="text" name="hero[gradient_mid]" value="{{ $heroVal('gradient_mid', '#15803d') }}" class="w-28" placeholder="#15803d">
                    </div>
                    <span class="text-gray-400">→</span>
                    <div class="flex items-center gap-2">
                        ...
                        <input type="text" name="hero[gradient_end]" value="{{ $heroVal('gradient_end', '#059669') }}" class="w-28" placeholder="#059669">
                    </div>
                </div>
            </div>
            <div class="border-t border-gray-100 pt-4">
                ...
                <div class="flex items-center gap-3 flex-wrap">
                    <div class="flex items-center gap-2">
                        ...
                        <input type="text" name="hero[title_gradient_start]" value="{{ $heroVal('title_gradient_start', '#86efac') }}" class="w-28" placeholder="#86efac">
                    </div>
                    <span class="text-gray-400">→</span>
                    <div class="flex items-center gap-2">
                        ...
                        <input type="text" name="hero[title_gradient_end]" value="{{ $heroVal('title_gradient_end', '#34d399') }}" class="w-28" placeholder="#34d399">
                    </div>
                </div>
            </div>
        </div>
