...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-green-500">
        ...
        <a href="{{ route("admin.noticias.index") }}" class="text-green-600 text-xs mt-2 block hover:underline">Gerenciar noticias</a>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-red-500">
        <div class="flex items-center justify-between">
            <div><p class="text-gray-500 text-sm">Mensagens Novas</p><p class="text-3xl font-black text-gray-900">{{ $stats["contacts"] }}</p></div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-orange-500">
        <div class="flex items-center justify-between">
            <div><p class="text-gray-500 text-sm">Manutencao</p><p class="text-xl font-black text-gray-900">{{ $maintenanceMode == "1" ? "ATIVA" : "Desativada" }}</p></div>
        ...
        <a href="{{ route("admin.settings.index") }}" class="text-orange-600 text-xs mt-2 block hover:underline">Configurar</a>
    </div>
</div>
