...
$titleUseGradient = cms('about', 'hero', 'title_use_gradient', '') === '1';
$titleGradStart = cms('about', 'hero', 'title_gradient_start', '#86efac');
$titleGradEnd = cms('about', 'hero', 'title_gradient_end', '#34d399');
...
<div style="background:linear-gradient(135deg,{{ $g1 }} 0%,{{ $g2 }} 50%,{{ $g3 }} 100%);padding:56px 0 40px;">
    <div style="max-width:1280px;margin:0 auto;padding:0 16px;">
        ...
        @php
            $titlePart = cms('about', 'hero', 'title', 'Instituto');
