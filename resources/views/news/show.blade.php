            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="mt-16 pt-10 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-6">
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        {{-- WhatsApp --}}
                        <a href="https://wa.me/?text={{ $shareTitle }}%20{{ $shareUrl }}" target="_blank" rel="noopener" title="WhatsApp" data-tooltip="WhatsApp"
                        ...
                        {{-- Facebook --}}
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ $shareUrl }}" target="_blank" rel="noopener" title="Facebook" data-tooltip="Facebook"
                        ...
                        {{-- X (Twitter) --}}
                        <a href="https://twitter.com/intent/tweet?url={{ $shareUrl }}&text={{ $shareTitle }}" target="_blank" rel="noopener" title="X (Twitter)" data-tooltip="X (Twitter)"
                        ...
                        {{-- LinkedIn --}}
                        <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ $shareUrl }}" target="_blank" rel="noopener" title="LinkedIn" data-tooltip="LinkedIn"
                        ...
                        {{-- Telegram --}}
                        <a href="https://t.me/share/url?url={{ $shareUrl }}&text={{ $shareTitle }}" target="_blank" rel="noopener" title="Telegram" data-tooltip="Telegram"
                        ...
                        {{-- Email --}}
                        <a href="mailto:?subject={{ $shareTitle }}&body={{ $shareTitle }}%20-%20{{ $shareUrl }}" title="Enviar por e-mail" data-tooltip="Enviar por e-mail"
                        ...
                        {{-- Copiar link --}}
                        <button type="button" onclick="navigator.clipboard.writeText(window.location.href).then(function(){this.title='Copiado!';this.classList.add('text-green-600','border-green-300','bg-green-50');setTimeout(function(){},1500)}.bind(this))" title="Copiar link" data-tooltip="Copiar link"
                           class="w-10 h-10 rounded-full flex items-center justify-center border border-gray-100 bg-gray-50 text-gray-500 hover:bg-green-50 hover:text-green-600 hover:border-green-200 transition-all">
