...
<div class="flex h-screen overflow-hidden">
    ...
    <aside id="sidebar" class="admin-sidebar w-64 flex-shrink-0 text-white flex flex-col z-30 fixed lg:relative h-full -translate-x-full lg:translate-x-0 transition-transform duration-300">
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto custom-scrollbar">
            ...
            {{-- Gestão de Conteúdo --}}
            <div class="nav-dropdown {{ request()->routeIs('admin.banners*', 'admin.noticias*', 'admin.projetos*', 'admin.galeria*', 'admin.paginas*', 'admin.transparencia*', 'admin.cms-original-pages*') ? 'active' : '' }}">
                ...
                <div class="nav-dropdown-content space-y-1 pl-6 mt-1">
                    <a href="{{ route('admin.banners.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.banners*') ? 'sidebar-link-active' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                        <span>Banners</span>
                    </a>
                    <a href="{{ route('admin.noticias.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.noticias*') ? 'sidebar-link-active' : '' }}">
                    ...
                    <a href="{{ route('admin.projetos.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.projetos*') ? 'sidebar-link-active' : '' }}">
                    ...
                    <a href="{{ route('admin.galeria.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.galeria*') ? 'sidebar-link-active' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                        <span>Galeria</span>
                    </a>
                    <a href="{{ route('admin.cms-original-pages.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.cms-original-pages*') ? 'sidebar-link-active' : '' }}">
                        ...
                        <span>CMS Páginas Originais</span>
                    </a>
                    <a href="{{ route('admin.paginas.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.paginas*') ? 'sidebar-link-active' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        <span>Páginas Dinâmicas</span>
                    </a>
                    <a href="{{ route('admin.transparencia.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.transparencia*') ? 'sidebar-link-active' : '' }}">
            ...
            {{-- Institucional --}}
            <div class="nav-dropdown {{ request()->routeIs('admin.equipe*', 'admin.depoimentos*', 'admin.parceiros*', 'admin.ods*') ? 'active' : '' }}">
                <button type="button" class="w-full flex items-center justify-between gap-3 px-3 py-2.5 rounded-lg text-green-100 hover:bg-green-700 hover:text-white transition-colors nav-dropdown-trigger">
                    <div class="flex items-center gap-3">
                ...
                <div class="nav-dropdown-content space-y-1 pl-6 mt-1">
                    <a href="{{ route('admin.equipe.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.equipe*') ? 'sidebar-link-active' : '' }}">
                    ...
                    <a href="{{ route('admin.depoimentos.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.depoimentos*') ? 'sidebar-link-active' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>
                        <span>Depoimentos</span>
                    </a>
                    <a href="{{ route('admin.parceiros.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.parceiros*') ? 'sidebar-link-active' : '' }}">
                    ...
                    <a href="{{ route('admin.ods.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.ods*') ? 'sidebar-link-active' : '' }}">
            ...
            <div class="nav-dropdown {{ request()->routeIs('admin.cms.*') ? 'active' : '' }}">
                <button type="button" class="w-full flex items-center justify-between gap-3 px-3 py-2.5 rounded-lg text-green-100 hover:bg-green-700 hover:text-white transition-colors nav-dropdown-trigger">
                    <div class="flex items-center gap-3">
                        ...
                        <span>CMS Institucional</span>
                    </div>
                    <svg class="w-4 h-4 transition-transform nav-dropdown-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                </button>
                <div class="nav-dropdown-content space-y-1 pl-6 mt-1">
                    <a href="{{ route('admin.cms.pages.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.cms.pages*') ? 'sidebar-link-active' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        <span>Páginas</span>
                    </a>
                    <a href="{{ route('admin.cms.sections.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.cms.sections*') ? 'sidebar-link-active' : '' }}">
                    ...
                    <a href="{{ route('admin.cms.blocks.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.cms.blocks*') ? 'sidebar-link-active' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/></svg>
                        <span>Blocos</span>
                    </a>
                    <a href="{{ route('admin.cms.menus.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.cms.menus*') ? 'sidebar-link-active' : '' }}">
                    ...
                    <a href="{{ route('admin.cms.media.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.cms.media*') ? 'sidebar-link-active' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                        <span>Mídias</span>
                    </a>
                    <a href="{{ route('admin.cms.pages.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.cms.seo*', 'admin.cms.pages*') ? 'sidebar-link-active' : '' }}">
                    ...
                    <a href="{{ route('admin.cms.audit.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.cms.audit*') ? 'sidebar-link-active' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
                        <span>Auditoria</span>
                    </a>
                    <a href="{{ route('admin.cms.versions.index', ['modelType' => 'page', 'modelId' => 1]) }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.cms.versions*') ? 'sidebar-link-active' : '' }}">
                    ...
                    <a href="{{ route('admin.cms.cache.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.cms.cache*') ? 'sidebar-link-active' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg>
                        <span>Cache</span>
                    </a>
                </div>
            ...
            <div class="nav-dropdown {{ request()->routeIs('admin.faq*', 'admin.analytics*', 'admin.contatos*', 'admin.settings*', 'admin.ips-manutencao*') ? 'active' : '' }}">
                ...
                <div class="nav-dropdown-content space-y-1 pl-6 mt-1">
                    <a href="{{ route('admin.faq.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.faq*') ? 'sidebar-link-active' : '' }}">
                    ...
                    <a href="{{ route('admin.analytics.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.analytics*') ? 'sidebar-link-active' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                        <span>Analytics</span>
                    </a>
                    <a href="{{ route('admin.contatos.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.contatos*') ? 'sidebar-link-active' : '' }}">
                    ...
                    <a href="{{ route('admin.settings.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.settings*') ? 'sidebar-link-active' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                        <span>Configurações</span>
                    </a>
                    <a href="{{ route('admin.ips-manutencao.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.ips-manutencao*') ? 'sidebar-link-active' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
                        <span>IPs Manutenção</span>
                    </a>
                </div>
            </div>
        </nav>
    ...
    <div class="flex-1 flex flex-col overflow-hidden" style="min-width:0;">
        ...
        @php
            ...
            $crumbMap = [
                ...
                'admin.cms-original-pages' => 'CMS Páginas Originais',
