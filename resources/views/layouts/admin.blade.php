        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto custom-scrollbar">
            ...
            <div class="nav-dropdown {{ request()->routeIs('admin.cms.*') ? 'active' : '' }}">
                ...
                <div class="nav-dropdown-content space-y-1 pl-6 mt-1">
                    ...
                    <a href="{{ route('admin.cms.seo.edit', 1) }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.cms.seo*') ? 'sidebar-link-active' : '' }}">
