...
<div class="flex h-screen overflow-hidden">
    ...
    <aside id="sidebar" class="admin-sidebar w-64 flex-shrink-0 text-white flex flex-col z-30 fixed lg:relative h-full -translate-x-full lg:translate-x-0 transition-transform duration-300">
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto custom-scrollbar">
            ...
            {{-- Gestão de Conteúdo --}}
            <div class="nav-dropdown {{ request()->routeIs('admin.banners*', 'admin.noticias*', 'admin.projetos*', 'admin.galeria*', 'admin.paginas*', 'admin.transparencia*', 'admin.cms-public-pages*') ? 'active' : '' }}">
                ...
                <div class="nav-dropdown-content space-y-1 pl-6 mt-1">
                    ...
                    <a href="{{ route('admin.cms-public-pages.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-green-100 hover:bg-green-700 hover:text-white transition-all {{ request()->routeIs('admin.cms-public-pages*') ? 'sidebar-link-active' : '' }}">
                        ...
                        <span>CMS Páginas Públicas</span>
                    </a>
