...
@php
$g1 = cms('ods', 'hero', 'gradient_start', '#166534');
$g2 = cms('ods', 'hero', 'gradient_mid', '#15803d');
$g3 = cms('ods', 'hero', 'gradient_end', '#059669');
$bcColor = cms('ods', 'hero', 'breadcrumb_color', '#86efac');
$titleHighlight = cms('ods', 'hero', 'title_highlight', 'Sustentável');
$titleColor = cms('ods', 'hero', 'title_highlight_color', '#86efac');
$titleUseGradient = cms('ods', 'hero', 'title_use_gradient', '') === '1';
$titleGradStart = cms('ods', 'hero', 'title_gradient_start', '#86efac');
$titleGradEnd = cms('ods', 'hero', 'title_gradient_end', '#34d399');
$subColor = cms('ods', 'hero', 'subtitle_color', '#bbf7d0');
@endphp
...
<div style="background:linear-gradient(135deg,{{ $g1 }} 0%,{{ $g2 }} 50%,{{ $g3 }} 100%);padding:56px 0 40px;">
    <div style="max-width:1280px;margin:0 auto;padding:0 16px;">
        <div style="display:flex;align-items:center;gap:8px;font-size:13px;color:{{ $bcColor }};margin-bottom:16px;">
            ...
            <span style="color:#fff;">{{ cms('ods', 'hero', 'breadcrumb', 'ODS 2030') }}</span>
        </div>
        @php
            $fullTitle = cms('ods', 'hero', 'title', 'Objetivos de Desenvolvimento');
        @endphp
        ...
        <p style="font-size:16px;color:{{ $subColor }};max-width:600px;margin-bottom:20px;">
            {{ cms('ods', 'hero', 'subtitle', 'Nossas ações estão alinhadas à Agenda 2030 da ONU para construir um futuro mais justo e sustentável.') }}
        </p>
        <div style="display:flex;flex-wrap:wrap;gap:10px;">
            <div class="page-stat">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                {{ $odsList->count() }} {{ cms('ods', 'hero', 'stat_label', 'Objetivos integrados') }}
            </div>
        </div>
    </div>
</div>
...
<section class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-12 text-center max-w-3xl mx-auto">
            <h2 class="text-3xl font-black text-gray-900 mb-4">{{ cms('ods', 'intro', 'title', 'A Agenda 2030') }}</h2>
            <p class="text-gray-600 leading-relaxed">
                {!! cms_html('ods', 'intro', 'text', 'Adotada por todos os Estados-Membros das Nações Unidas, a Agenda 2030 fornece um plano compartilhado para a paz e a prosperidade das pessoas e do planeta, agora e no futuro. No ISSM, cada projeto é pensado para impactar positivamente um ou mais destes objetivos.') !!}
            </p>
        </div>
