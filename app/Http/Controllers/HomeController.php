...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $homeStats = [
            [
                'value' => (string) (max(0, (int) Setting::get('home_stat_1_base', 0)) + $activeOdsCount),
                'suffix' => trim((string) Setting::get('home_stat_1_suffix', '')),
                'label' => Setting::get('home_stat_1_label', 'ODS Alinhados'),
            ],
            [
                'value' => Setting::get('home_stat_2_value', '2030'),
                'suffix' => trim((string) Setting::get('home_stat_2_suffix', '')),
                'label' => Setting::get('home_stat_2_label', 'Meta Global'),
            ],
            [
                'value' => (string) (max(0, (int) Setting::get('home_stat_3_base', 10)) + $activeProjectsCount),
                'suffix' => trim((string) Setting::get('home_stat_3_suffix', '+')),
                'label' => Setting::get('home_stat_3_label', 'Projetos Ativos'),
            ],
            [
                'value' => Setting::get('home_stat_4_value', 'RJ'),
                'suffix' => trim((string) Setting::get('home_stat_4_suffix', '')),
                'label' => Setting::get('home_stat_4_label', 'Serra do Mendanha'),
            ],
        ];
