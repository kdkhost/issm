...
class ProjectSupportController extends Controller
{
    ...
    public function updateGateway(Request $request)
    {
        $validated = $request->validate([
            ...
            'donation_mercadopago_public_key'            => 'nullable|string|max:500',
            'donation_mercadopago_public_key_sandbox'    => 'nullable|string|max:500',
            // Stripe
            ...
            'donation_pagbank_public_key'                => 'nullable|string|max:500',
            // Asaas
            ...
            'donation_efi_client_id'                     => 'nullable|string|max:500',
            'donation_efi_api_key'                       => 'nullable|string|max:1000',
            'donation_efi_client_id_sandbox'             => 'nullable|string|max:500',
            'donation_efi_api_key_sandbox'               => 'nullable|string|max:1000',
            'donation_efi_pix_key'                       => 'nullable|string|max:255',
        ]);
