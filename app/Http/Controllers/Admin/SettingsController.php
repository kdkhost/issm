...
class SettingsController extends Controller
{
    ...
    private function ensureSystemSettings(): void
    {
        ...
        $homeStatSettings = [
            ...
            ['key' => 'contact_notification_email_enabled', 'value' => '1', 'type' => 'boolean', 'group' => 'contact', 'label' => 'Enviar e-mail ao administrador para acoes do site'],
            ['key' => 'contact_notification_to', 'value' => '', 'type' => 'text', 'group' => 'contact', 'label' => 'E-mail do administrador para notificacoes'],
            ['key' => 'contact_notification_bcc', 'value' => '', 'type' => 'textarea', 'group' => 'contact', 'label' => 'Copia oculta (BCC) para membros da empresa'],
            ['key' => 'contact_notification_sound_enabled', 'value' => '1', 'type' => 'boolean', 'group' => 'contact', 'label' => 'Ativar alerta sonoro no sininho administrativo'],
        ];
