...
<?php $__env->startSection("title", "Inicio - ISSM"); ?>
...
<section class="relative overflow-hidden">
    <div id="banner-slider">
        ...
        <div class="banner-slide <?php echo e($index > 0 ? "hidden" : ""); ?> relative min-h-[500px] lg:min-h-[600px] flex items-center <?php echo e(!$banner->image ? "hero-gradient" : ""); ?>"
             <?php if($banner->image): ?> style="background-image:url(<?php echo e(asset("media/".$banner->image)); ?>);background-size:cover;background-position:center;" <?php endif; ?>>
            <?php if($banner->image): ?><div class="absolute inset-0 bg-black/50"></div><?php endif; ?>
            <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <h1 class="text-4xl lg:text-6xl font-black text-white leading-tight mb-4"><?php echo e($banner->title); ?></h1>
                <?php if($banner->subtitle): ?><p class="text-xl text-green-100 mb-8 max-w-2xl"><?php echo e($banner->subtitle); ?></p><?php endif; ?>
                <?php if($banner->button_text && $banner->button_url): ?>
                <a href="<?php echo e($banner->button_url); ?>" class="inline-block bg-white text-green-800 font-bold px-8 py-3 rounded-full hover:bg-green-50 shadow-lg"><?php echo e($banner->button_text); ?></a>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 z-20">
        <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <button class="banner-dot w-3 h-3 rounded-full <?php echo e($index === 0 ? "bg-white" : "bg-white/50"); ?>" data-index="<?php echo e($index); ?>"></button>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
    <?php endif; ?>
</section>
...
<section
    ...
    <?php if($heroBg): ?>
        background-image:url(<?php echo e(asset('media/'.$heroBg)); ?>);background-size:cover;background-position:center;
    <?php else: ?>
    ...
    <div style="position:absolute;inset:0;background:linear-gradient(135deg,
        rgba(20,83,45,<?php echo e($heroAlpha); ?>),
        rgba(21,128,61,<?php echo e($heroAlpha * 0.88); ?>),
        rgba(5,150,105,<?php echo e($heroAlpha * 0.75); ?>));z-index:1;"></div>
    <?php endif; ?>
...
<section class="bg-green-800 text-white py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            ...
            <div><p class="text-3xl font-black"><?php echo e($featuredProjects->count() + 10); ?>+</p><p class="text-green-300 text-sm">Projetos Ativos</p></div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <p class="text-gray-600 leading-relaxed mb-6"><?php echo e($settings["about_text"]); ?></p>
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div class="bg-green-50 rounded-xl p-4 border-l-4 border-green-600"><h4 class="font-bold text-green-800 mb-2">Missao</h4><p class="text-gray-600 text-sm"><?php echo e($settings["mission"]); ?></p></div>
                    <div class="bg-blue-50 rounded-xl p-4 border-l-4 border-blue-600"><h4 class="font-bold text-blue-800 mb-2">Visao</h4><p class="text-gray-600 text-sm"><?php echo e($settings["vision"]); ?></p></div>
                    <div class="bg-yellow-50 rounded-xl p-4 border-l-4 border-yellow-600"><h4 class="font-bold text-yellow-800 mb-2">Valores</h4><p class="text-gray-600 text-sm"><?php echo e($settings["values"]); ?></p></div>
                </div>
            </div>
            <div class="bg-gradient-to-br from-green-100 to-green-200 rounded-2xl p-8 text-center">
                <div class="w-32 h-32 bg-gradient-to-br from-green-700 to-green-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-xl" style="overflow:hidden;">
                    <?php $odsLogo = \App\Models\Setting::get('site_logo'); ?>
                    <?php if($odsLogo): ?>
                    <img src="<?php echo e(asset('media/' . $odsLogo)); ?>" alt="ISSM" style="width:100%;height:100%;object-fit:cover;border-radius:50%;">
                    <?php else: ?>
                ...
                <div class="grid grid-cols-5 gap-2 mt-6">
                    <?php $__currentLoopData = range(1,17); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="ods-<?php echo e($n); ?> w-8 h-8 rounded flex items-center justify-center text-white text-xs font-bold"><?php echo e($n); ?></div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<section id="ods" class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-9 gap-3">
            <?php $__currentLoopData = $odsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ods): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="rounded-xl p-3 text-white text-center card-hover cursor-default" style="background-color: <?php echo e($ods->color); ?>" title="<?php echo e($ods->title); ?>">
                <p class="text-2xl font-black"><?php echo e($ods->number); ?></p>
                <p class="text-xs font-medium leading-tight mt-1"><?php echo e($ods->title); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<section id="projetos" class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-end mb-12">
            ...
            <a href="<?php echo e(route("projects.index")); ?>" class="text-green-700 hover:text-green-900 font-medium flex items-center gap-1">Ver todos <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></a>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <article class="bg-white rounded-2xl shadow-md overflow-hidden card-hover border border-gray-100">
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mt-3 mb-2"><?php echo e($project->title); ?></h3>
                    ...
                    <?php endif; ?>
                    <a href="<?php echo e(route("projects.show", $project->slug)); ?>" class="text-green-700 hover:text-green-900 font-medium text-sm flex items-center gap-1">Saiba mais <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></a>
                </div>
            </article>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<section id="noticias" class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-end mb-12">
            ...
            <a href="<?php echo e(route("news.index")); ?>" class="text-green-700 hover:text-green-900 font-medium flex items-center gap-1">Ver todas <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></a>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <article class="bg-white rounded-2xl shadow-md overflow-hidden card-hover border border-gray-100">
                <?php if($news->image): ?><img src="<?php echo e(asset("media/".$news->image)); ?>" alt="<?php echo e($news->title); ?>" class="w-full h-48 object-cover"><?php else: ?><div class="w-full h-48 bg-gradient-to-br from-blue-50 to-green-50 flex items-center justify-center"><svg class="w-16 h-16 text-green-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"/></svg></div><?php endif; ?>
                <div class="p-6">
                    <?php if($news->category): ?><span class="text-xs font-semibold text-blue-600 bg-blue-50 px-2 py-1 rounded-full"><?php echo e($news->category); ?></span><?php endif; ?>
                    <h3 class="text-xl font-bold text-gray-900 mt-3 mb-2"><?php echo e($news->title); ?></h3>
                    <p class="text-gray-600 text-sm leading-relaxed mb-4"><?php echo e($news->excerpt ?? Str::limit(strip_tags($news->content), 120)); ?></p>
                    <div class="flex justify-between items-center">
                        <span class="text-xs text-gray-400"><?php echo e($news->published_at ? $news->published_at->format("d/m/Y") : ""); ?></span>
                        <a href="<?php echo e(route("news.show", $news->slug)); ?>" class="text-green-700 hover:text-green-900 font-medium text-sm flex items-center gap-1">Ler mais <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></a>
                    </div>
                </div>
            </article>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
            ...
            <div class="text-center">
                <div class="w-24 h-24 mx-auto rounded-full overflow-hidden mb-3 shadow-md">
                    <?php if($member->photo): ?><img src="<?php echo e(asset("media/".$member->photo)); ?>" alt="<?php echo e($member->name); ?>" class="w-full h-full object-cover"><?php else: ?><div class="w-full h-full bg-gradient-to-br from-green-100 to-green-200 flex items-center justify-center"><span class="text-green-700 font-black text-2xl"><?php echo e(substr($member->name, 0, 1)); ?></span></div><?php endif; ?>
                </div>
                <h4 class="font-bold text-gray-900 text-sm"><?php echo e($member->name); ?></h4>
                <p class="text-green-600 text-xs"><?php echo e($member->role); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<section id="galeria" class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-end mb-12">
            ...
            <a href="<?php echo e(route('gallery.index')); ?>" class="text-green-700 hover:text-green-900 font-medium flex items-center gap-1">Ver tudo <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></a>
        </div>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <?php $__currentLoopData = $galleryItems->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('gallery.index')); ?>" class="group overflow-hidden rounded-xl shadow-md block">
                <img src="<?php echo e(asset('media/'.$item->image)); ?>" alt="<?php echo e($item->title); ?>"
                     class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300">
            </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <?php if($galleryItems->count() > 4): ?>
        <div class="text-center mt-8">
            <a href="<?php echo e(route('gallery.index')); ?>" class="inline-flex items-center gap-2 bg-green-700 hover:bg-green-800 text-white font-semibold px-8 py-3 rounded-full transition-colors shadow-md">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                Ver galeria completa (<?php echo e($galleryItems->count()); ?>+ fotos)
            </a>
        </div>
        <?php endif; ?>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="partners-swiper swiper" id="partners-swiper">
            <div class="swiper-wrapper">
                ...
                <?php $partnerUrl = $partner->url ?? null; ?>
                <div class="swiper-slide flex items-center justify-center">
                    <?php if($partner->logo): ?>
                        <?php if($partnerUrl): ?>
                        <a href="<?php echo e($partnerUrl); ?>"
                           target="_blank" rel="noopener noreferrer"
                           class="partner-logo-wrap partner-tooltip-wrap">
                            <img src="<?php echo e(asset('media/' . $partner->logo)); ?>"
                                 alt="<?php echo e($partner->name); ?>"
                                 style="height:<?php echo e($pLogoH); ?>px; width:160px; object-fit:contain;">
                    ...
                    <div class="partner-logo-wrap bg-gray-100 rounded-lg px-6 text-gray-600 font-semibold"
                         style="height:<?php echo e($pLogoH); ?>px;">
                        <?php echo e($partner->name); ?>
...
<script>
(function() {
    var effect      = '<?php echo e($pEffect); ?>';
    var speed       = <?php echo e($pSpeed); ?>;
    var autoplay    = <?php echo e($pAutoplay ? 'true' : 'false'); ?>;
    var loopWanted  = <?php echo e($pLoop ? 'true' : 'false'); ?>;
    var perView     = <?php echo e($pPerView); ?>;
    var dots        = <?php echo e($pDots ? 'true' : 'false'); ?>;
    var arrows      = <?php echo e($pArrows ? 'true' : 'false'); ?>;
    var totalSlides = <?php echo e($partners->count()); ?>;
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
                ...
                <div class="space-y-4">
                    <?php if($settings["contact_email"]): ?><div class="flex items-center gap-3"><div class="w-10 h-10 bg-green-700 rounded-full flex items-center justify-center flex-shrink-0"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg></div><span class="text-green-100"><?php echo e($settings["contact_email"]); ?></span></div><?php endif; ?>
                    <?php if($settings["contact_phone"]): ?><div class="flex items-center gap-3"><div class="w-10 h-10 bg-green-700 rounded-full flex items-center justify-center flex-shrink-0"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg></div><span class="text-green-100"><?php echo e($settings["contact_phone"]); ?></span></div><?php endif; ?>
                    <?php if($settings["contact_address"]): ?><div class="flex items-center gap-3"><div class="w-10 h-10 bg-green-700 rounded-full flex items-center justify-center flex-shrink-0"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg></div><span class="text-green-100"><?php echo e($settings["contact_address"]); ?></span></div><?php endif; ?>
                </div>
                <div class="flex gap-4 mt-8">
                    <?php if($settings["social_facebook"]): ?><a href="<?php echo e($settings["social_facebook"]); ?>" target="_blank" class="w-10 h-10 bg-green-700 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors"><svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg></a><?php endif; ?>
                    <?php if($settings["social_instagram"]): ?><a href="<?php echo e($settings["social_instagram"]); ?>" target="_blank" class="w-10 h-10 bg-green-700 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors"><svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg></a><?php endif; ?>
                    <?php if($settings["social_youtube"]): ?><a href="<?php echo e($settings["social_youtube"]); ?>" target="_blank" class="w-10 h-10 bg-green-700 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors"><svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M23.495 6.205a3.007 3.007 0 00-2.088-2.088c-1.87-.501-9.396-.501-9.396-.501s-7.507-.01-9.396.501A3.007 3.007 0 00.527 6.205a31.247 31.247 0 00-.522 5.805 31.247 31.247 0 00.522 5.783 3.007 3.007 0 002.088 2.088c1.868.502 9.396.502 9.396.502s7.506 0 9.396-.502a3.007 3.007 0 002.088-2.088 31.247 31.247 0 00.5-5.783 31.247 31.247 0 00-.5-5.805zM9.609 15.601V8.408l6.264 3.602z"/></svg></a><?php endif; ?>
                </div>
            </div>
            <div>
                <?php if(session("success")): ?><div class="bg-green-700 border border-green-500 text-white px-4 py-3 rounded-lg mb-4"><?php echo e(session("success")); ?></div><?php endif; ?>
                <form action="<?php echo e(route("contact.store")); ?>" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div><input type="text" name="name" placeholder="Seu nome *" required class="w-full bg-green-800 border border-green-700 text-white placeholder-green-400 rounded-lg px-4 py-3 focus:outline-none focus:border-green-400" value="<?php echo e(old("name")); ?>"><?php $__errorArgs = ["name"];
...
unset($__errorArgs, $__bag); ?></div>
                        <div><input type="email" name="email" placeholder="Seu e-mail *" required class="w-full bg-green-800 border border-green-700 text-white placeholder-green-400 rounded-lg px-4 py-3 focus:outline-none focus:border-green-400" value="<?php echo e(old("email")); ?>"><?php $__errorArgs = ["email"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-300 text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?></div>
                    ...
                    <div><input type="tel" name="phone" placeholder="Telefone" class="w-full bg-green-800 border border-green-700 text-white placeholder-green-400 rounded-lg px-4 py-3 focus:outline-none focus:border-green-400" value="<?php echo e(old("phone")); ?>"></div>
                    <div><input type="text" name="subject" placeholder="Assunto *" required class="w-full bg-green-800 border border-green-700 text-white placeholder-green-400 rounded-lg px-4 py-3 focus:outline-none focus:border-green-400" value="<?php echo e(old("subject")); ?>"><?php $__errorArgs = ["subject"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-300 text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?></div>
                    <div><textarea name="message" placeholder="Sua mensagem *" required rows="5" class="w-full bg-green-800 border border-green-700 text-white placeholder-green-400 rounded-lg px-4 py-3 focus:outline-none focus:border-green-400"><?php echo e(old("message")); ?></textarea><?php $__errorArgs = ["message"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-300 text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?></div>
                    <?php $recaptchaKey = \App\Models\Setting::get('recaptcha_site_key'); ?>
                    <?php if($recaptchaKey): ?>
                    <div class="flex justify-center sm:justify-start">
                        <div class="g-recaptcha" data-sitekey="<?php echo e($recaptchaKey); ?>" data-theme="dark"></div>
                    </div>
                    <?php $__errorArgs = ['g-recaptcha-response'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-300 text-xs -mt-2">Por favor, confirme que você não é um robô.</p><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/issmorg/public_html/resources/views/home.blade.php ENDPATH**/ ?>