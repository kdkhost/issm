...
<head>
    ...
    <?php if(session('success')): ?><meta name="flash-success" content="<?php echo e(session('success')); ?>"><?php endif; ?>
    <?php if(session('error')): ?><meta name="flash-error" content="<?php echo e(session('error')); ?>"><?php endif; ?>
    <title><?php echo $__env->yieldContent('title', 'Painel Admin'); ?> - ISSM Admin</title>
    <?php $siteFavicon = \App\Models\Setting::get('site_favicon'); ?>
    <?php if($siteFavicon): ?>
    ...
    <style>
        ...
        /* ═══ OVERFLOW GLOBAL ═══
           Usa clip no html (não cria containing block para position:fixed, evita overlay preto)
           e hidden só no body para suprimir scrollbar horizontal */
...
<div class="flex h-screen overflow-hidden">
    ...
    <aside id="sidebar" class="admin-sidebar w-64 flex-shrink-0 text-white flex flex-col z-30 fixed lg:relative h-full -translate-x-full lg:translate-x-0 transition-transform duration-300">
        ...
        <div class="p-6 border-b border-green-700">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-3">
                ...
                <?php if($siteLogo): ?>
                <img src="<?php echo e(asset('media/' . $siteLogo)); ?>" alt="ISSM" class="h-10 w-auto object-contain rounded" style="max-height:40px;">
                <?php else: ?>
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-green-100 hover:bg-green-700 hover:text-white transition-colors <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-green-700 text-white' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.banners.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-green-100 hover:bg-green-700 hover:text-white transition-colors <?php echo e(request()->routeIs('admin.banners*') ? 'bg-green-700 text-white' : ''); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                Banners
            </a>

            <a href="<?php echo e(route('admin.noticias.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-green-100 hover:bg-green-700 hover:text-white transition-colors <?php echo e(request()->routeIs('admin.noticias*') ? 'bg-green-700 text-white' : ''); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"/></svg>
                Notícias
            </a>

            <a href="<?php echo e(route('admin.projetos.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-green-100 hover:bg-green-700 hover:text-white transition-colors <?php echo e(request()->routeIs('admin.projetos*') ? 'bg-green-700 text-white' : ''); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                Projetos
            </a>

            <a href="<?php echo e(route('admin.galeria.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-green-100 hover:bg-green-700 hover:text-white transition-colors <?php echo e(request()->routeIs('admin.galeria*') ? 'bg-green-700 text-white' : ''); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                Galeria
            </a>

            <a href="<?php echo e(route('admin.paginas.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-green-100 hover:bg-green-700 hover:text-white transition-colors <?php echo e(request()->routeIs('admin.paginas*') ? 'bg-green-700 text-white' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.equipe.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-green-100 hover:bg-green-700 hover:text-white transition-colors <?php echo e(request()->routeIs('admin.equipe*') ? 'bg-green-700 text-white' : ''); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                Equipe
            </a>

            <a href="<?php echo e(route('admin.parceiros.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-green-100 hover:bg-green-700 hover:text-white transition-colors <?php echo e(request()->routeIs('admin.parceiros*') ? 'bg-green-700 text-white' : ''); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                Parceiros
            </a>

            <a href="<?php echo e(route('admin.ods.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-green-100 hover:bg-green-700 hover:text-white transition-colors <?php echo e(request()->routeIs('admin.ods*') ? 'bg-green-700 text-white' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.analytics.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-green-100 hover:bg-green-700 hover:text-white transition-colors <?php echo e(request()->routeIs('admin.analytics*') ? 'bg-green-700 text-white' : ''); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                Analytics
            </a>

            <a href="<?php echo e(route('admin.contatos.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-green-100 hover:bg-green-700 hover:text-white transition-colors <?php echo e(request()->routeIs('admin.contatos*') ? 'bg-green-700 text-white' : ''); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                Mensagens
                <?php $newContacts = \App\Models\Contact::where('status','new')->count(); ?>
                <?php if($newContacts > 0): ?><span class="ml-auto bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center"><?php echo e($newContacts); ?></span><?php endif; ?>
            </a>

            <a href="<?php echo e(route('admin.settings.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-green-100 hover:bg-green-700 hover:text-white transition-colors <?php echo e(request()->routeIs('admin.settings*') ? 'bg-green-700 text-white' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.ips-manutencao.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-green-100 hover:bg-green-700 hover:text-white transition-colors <?php echo e(request()->routeIs('admin.ips-manutencao*') ? 'bg-green-700 text-white' : ''); ?>">
    ...
    <div class="flex-1 flex flex-col overflow-hidden" style="min-width:0;">
        ...
        <header class="bg-white shadow-sm z-10 flex-shrink-0" style="overflow:visible;">
            <div class="flex items-center justify-between px-6 py-3">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <?php $maintenanceMode = \App\Models\Setting::get('maintenance_mode', '0'); ?>
                    ...
                    <?php endif; ?>
                    <a href="<?php echo e(route('home')); ?>" target="_blank" class="text-sm text-green-700 hover:text-green-900 flex items-center gap-1" data-tooltip="Abrir site em nova aba" data-tip-pos="left">
                    ...
                    <div class="relative" id="user-dropdown-wrap">
                        <button id="user-dropdown-btn" class="flex items-center gap-2 px-2 py-1 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors focus:outline-none" aria-haspopup="true" aria-expanded="false">
                            ...
                            <span class="hidden md:block text-sm font-medium text-gray-700 dark:text-gray-200 max-w-[120px] truncate"><?php echo e(Str::words(auth()->user()->name, 2, '')); ?></span>
                        ...
                        <div id="user-dropdown" style="display:none;position:fixed;z-index:9999;width:240px;" class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                            ...
                            <div class="px-4 py-3 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-gray-700 dark:to-gray-700 border-b border-gray-100 dark:border-gray-600">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="min-w-0">
                                        <p class="font-semibold text-gray-800 dark:text-white text-sm truncate"><?php echo e(auth()->user()->name); ?></p>
                                        <p class="text-gray-500 dark:text-gray-400 text-xs truncate"><?php echo e(auth()->user()->email); ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="py-1">
                                <a href="<?php echo e(route('admin.profile.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
        ...
        <div class="bg-white border-b border-gray-100 px-6 py-1.5">
            <nav class="flex items-center gap-1 text-xs text-gray-400" aria-label="Breadcrumb">
                <?php $__currentLoopData = $breadcrumbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $crumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($i > 0): ?><svg class="w-3 h-3 flex-shrink-0 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg><?php endif; ?>
                    <?php if($crumb['url'] && $i < count($breadcrumbs)-1): ?>
                        <a href="<?php echo e($crumb['url']); ?>" class="hover:text-green-700 transition-colors"><?php echo e($crumb['label']); ?></a>
                    <?php else: ?>
                        <span class="<?php echo e($i === count($breadcrumbs)-1 ? 'text-gray-600 font-medium' : ''); ?>"><?php echo e($crumb['label']); ?></span>
                    <?php endif; ?>
        ...
        <footer class="flex-shrink-0 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-6 py-2">
            <div class="flex flex-wrap items-center justify-between gap-2 text-xs text-gray-400 dark:text-gray-500">
                <span>&copy; <?php echo e(date('Y')); ?> ISSM &mdash; Painel Administrativo &bull; v1.0.0</span>
                <span class="hidden sm:flex items-center gap-2">
                    <span title="Laravel Framework">Laravel <?php echo e(app()->version()); ?></span>
                    <span class="text-gray-300 dark:text-gray-600">|</span>
                    <span title="PHP Version">PHP <?php echo e(phpversion()); ?></span>
                    <span class="text-gray-300 dark:text-gray-600">|</span>
                    <span title="Ambiente"><?php echo e(ucfirst(app()->environment())); ?></span>
                </span>
            </div>
        </footer>
    </div>
...
<button id="admin-back-to-top" title="Voltar ao topo"
    style="display:none;position:fixed;bottom:1.5rem;right:1.5rem;z-index:9998;width:2.5rem;height:2.5rem;border-radius:50%;background:#15803d;color:white;border:none;box-shadow:0 4px 14px rgba(0,0,0,.25);align-items:center;justify-content:center;cursor:pointer;transition:opacity .25s,transform .25s;opacity:0;"
...
<?php /**PATH /home/issmorg/public_html/resources/views/layouts/admin.blade.php ENDPATH**/ ?>