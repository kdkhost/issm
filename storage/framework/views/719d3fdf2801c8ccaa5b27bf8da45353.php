...
<head>
    ...
    ?>
    <title>Acesso Administrativo — <?php echo e($siteName); ?></title>
    <?php if($siteFavicon): ?>
    ...
    <aside class="login-left">
        ...
        <div class="left-content">
            <div class="brand-logo-wrap">
                <?php if($siteLogo): ?>
                    <img src="<?php echo e(asset('media/' . $siteLogo)); ?>" alt="<?php echo e($siteName); ?>">
                <?php else: ?>
                    <span class="fallback">ISSM</span>
                <?php endif; ?>
            </div>
            <div class="brand-name"><?php echo e($siteName); ?></div>
            <div class="brand-desc"><?php echo e($siteDesc); ?></div>
        ...
        <div class="left-footer">
            <?php $hasSocial = $facebook || $instagram || $youtube || $whatsapp; ?>
            <?php if($hasSocial): ?>
            <div class="social-links">
                ...
                <?php endif; ?>
                <?php if($whatsapp): ?>
                <a href="https://wa.me/<?php echo e(preg_replace('/\D/','',$whatsapp)); ?>" target="_blank" rel="noopener" class="social-link" title="WhatsApp">
            ...
            <?php endif; ?>
            <p class="left-copy">&copy; <?php echo e(date('Y')); ?> <?php echo e($siteName); ?>. Todos os direitos reservados.</p>
        </div>
    </aside>
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" id="login-form" novalidate>
                    ...
                    <div class="field">
                        <input type="email" name="email" id="email"
                               ...
                               class="<?php echo e($errors->has('email') ? 'has-error' : ''); ?>">
                    ...
                    <div class="field">
                        <div class="pwd-wrap">
                            <input type="password" name="password" id="password"
                                   ...
                                   class="<?php echo e($errors->has('password') ? 'has-error' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="card-footer">
                <p>&copy; <?php echo e(date('Y')); ?> <?php echo e($siteName); ?>. Todos os direitos reservados.</p>
            </div>
        </div>
    </main>
</div>
...
<?php /**PATH /home/issmorg/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>