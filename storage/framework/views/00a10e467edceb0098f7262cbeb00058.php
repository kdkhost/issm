...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Erro'); ?> - ISSM</title>
...
<body>
    ...
    <div class="err-box">
        ...
        <h1 class="err-title"><?php echo $__env->yieldContent('heading'); ?></h1>
        <p class="err-desc"><?php echo $__env->yieldContent('message'); ?></p>
        <div class="err-actions">
            <a href="<?php echo e(url('/')); ?>" class="err-btn err-btn--primary">
...
<?php /**PATH /home/issmorg/public_html/resources/views/errors/layout.blade.php ENDPATH**/ ?>