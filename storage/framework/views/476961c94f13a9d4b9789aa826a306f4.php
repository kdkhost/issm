...
<head>
    ...
    <?php if($seoKeywords): ?><meta name="keywords" content="<?php echo e($seoKeywords); ?>"><?php endif; ?>
    <?php if($seoAuthor): ?><meta name="author" content="<?php echo e($seoAuthor); ?>"><?php endif; ?>
    <?php if($seoRobots): ?><meta name="robots" content="<?php echo e($seoRobots); ?>"><?php endif; ?>
    <?php if($seoCanonical): ?><link rel="canonical" href="<?php echo e($seoCanonical); ?>"><?php endif; ?>

    
    <meta property="og:type" content="<?php echo e($ogType); ?>">
    <meta property="og:locale" content="<?php echo e($ogLocale); ?>">
    <meta property="og:site_name" content="<?php echo e($ogSiteName); ?>">
    <meta property="og:title" content="<?php echo $__env->yieldContent('og_title', $ogTitle); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('og_description', $ogDesc); ?>">
    <meta property="og:url" content="<?php echo e($seoCanonical ?: url()->current()); ?>">
    <?php if($ogImage): ?>
    <meta property="og:image" content="<?php echo e(asset('media/' . $ogImage)); ?>">
    <meta property="og:image:width" content="1200">
    <meta property="og:image:height" content="630">
    <meta property="og:image:type" content="image/<?php echo e(pathinfo($ogImage, PATHINFO_EXTENSION) === 'png' ? 'png' : 'jpeg'); ?>">
    <?php endif; ?>

    
    <meta name="twitter:card" content="<?php echo e($twCard); ?>">
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('twitter_title', $twTitle); ?>">
    <meta name="twitter:description" content="<?php echo $__env->yieldContent('twitter_description', $twDesc); ?>">
    <?php if($twHandle): ?><meta name="twitter:site" content="<?php echo e(str_starts_with($twHandle, '@') ? $twHandle : '@'.$twHandle); ?>"><?php endif; ?>
    <?php if($twImage): ?>
    <meta name="twitter:image" content="<?php echo e(asset('media/' . $twImage)); ?>">
    <?php elseif($ogImage): ?>
    <meta name="twitter:image" content="<?php echo e(asset('media/' . $ogImage)); ?>">
    <?php endif; ?>

    
    <?php if($googleVerify): ?><meta name="google-site-verification" content="<?php echo e($googleVerify); ?>"><?php endif; ?>
    <?php if($bingVerify): ?><meta name="msvalidate.01" content="<?php echo e($bingVerify); ?>"><?php endif; ?>

    
    <?php if($siteFavicon): ?>
    <link rel="icon" type="image/x-icon" href="<?php echo e(asset('media/' . $siteFavicon)); ?>">
    <link rel="apple-touch-icon" href="<?php echo e(asset('media/' . $siteFavicon)); ?>">
    <?php endif; ?>
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "Organization",
        "name": "<?php echo e($ogSiteName); ?>",
        "url": "<?php echo e($seoCanonical ?: url('/')); ?>",
        "description": "<?php echo e($seoDesc); ?>",
        <?php if($ogImage): ?>"logo": "<?php echo e(asset('media/' . $ogImage)); ?>",<?php endif; ?>
        <?php if($siteFavicon): ?>"image": "<?php echo e(asset('media/' . $siteFavicon)); ?>",<?php endif; ?>
        "address": {
            "@type": "PostalAddress",
        ...
        "sameAs": [
            ...
            ?>
            <?php echo collect($socialLinks)->map(fn($l) => '"'.e($l).'"')->implode(",\n            "); ?>
    ...
    <?php $recaptchaSiteKey = \App\Models\Setting::get('recaptcha_site_key'); ?>
...
<body class="bg-white text-gray-800">
    ...
    <div id="page-preloader" style="position:fixed;inset:0;background:#166534;z-index:9999;display:flex;flex-direction:column;align-items:center;justify-content:center;transition:opacity 0.35s ease;opacity:0;pointer-events:none;" aria-hidden="true">
        ...
        <?php if($siteLogo): ?>
        <img src="<?php echo e(asset('media/' . $siteLogo)); ?>" alt="ISSM" style="height:70px;width:auto;object-fit:contain;animation:pulse 1.2s ease-in-out infinite alternate;">
        <?php else: ?>
    ...
    <header class="bg-white shadow-md sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="main-hdr flex justify-between items-center">
                <!-- Logo -->
                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 sm:gap-3 h-full py-2 sm:py-2.5 lg:py-4">
                    <?php $siteLogo = \App\Models\Setting::get('site_logo'); ?>
                    <?php if($siteLogo): ?>
                    <img src="<?php echo e(asset('media/' . $siteLogo)); ?>" alt="<?php echo e(config('app.name')); ?>" class="main-hdr-logo h-full w-auto max-h-10 object-contain flex-shrink-0">
                    <?php else: ?>
                ...
                <nav class="hidden lg:flex items-center gap-8">
                    <a href="<?php echo e(route('home')); ?>" class="text-gray-700 hover:text-green-700 font-medium transition-colors">Início</a>
                    <a href="<?php echo e(route('home')); ?>#sobre" class="text-gray-700 hover:text-green-700 font-medium transition-colors">Sobre</a>
                    <a href="<?php echo e(route('projects.index')); ?>" class="text-gray-700 hover:text-green-700 font-medium transition-colors">Projetos</a>
                    <a href="<?php echo e(route('home')); ?>#ods" class="text-gray-700 hover:text-green-700 font-medium transition-colors">ODS 2030</a>
                    <a href="<?php echo e(route('news.index')); ?>" class="text-gray-700 hover:text-green-700 font-medium transition-colors">Notícias</a>
                    <a href="<?php echo e(route('gallery.index')); ?>" class="text-gray-700 hover:text-green-700 font-medium transition-colors">Galeria</a>
                    <a href="<?php echo e(route('home')); ?>#contato" class="bg-green-700 text-white px-5 py-2 rounded-full hover:bg-green-800 font-medium transition-colors">Contato</a>
                </nav>
    ...
    <div id="mobile-sidebar" class="fixed top-0 left-0 h-full w-[85vw] max-w-[360px] z-50 flex flex-col"
        ...
        <div class="relative overflow-hidden flex-shrink-0" style="background:linear-gradient(135deg,#14532d,#15803d);padding:28px 20px 20px;">
            ...
            <?php $siteLogo = \App\Models\Setting::get('site_logo'); $siteName = \App\Models\Setting::get('site_name','ISSM'); ?>
            <div class="flex items-center gap-3 relative">
                ...
                <div style="width:52px;height:52px;border-radius:14px;overflow:hidden;background:#fff;display:flex;align-items:center;justify-content:center;flex-shrink:0;box-shadow:0 2px 8px rgba(0,0,0,.2);">
                    <img src="<?php echo e(asset('media/' . $siteLogo)); ?>" alt="ISSM" style="width:100%;height:100%;object-fit:contain;">
                </div>
                <?php else: ?>
        ...
        <nav class="flex-1 overflow-y-auto" style="padding:12px 12px 8px;">
            ...
            <a href="<?php echo e(route('home')); ?>" data-nav-path="/" class="md-nav-item flex items-center gap-4 px-4 py-0" style="height:56px;text-decoration:none;">
            ...
            <a href="<?php echo e(route('home')); ?>#sobre" class="md-nav-item flex items-center gap-4 px-4 py-0" style="height:56px;text-decoration:none;">
                <div class="md-active-bg"></div>
            ...
            <a href="<?php echo e(route('projects.index')); ?>" data-nav-path="/projetos" class="md-nav-item flex items-center gap-4 px-4 py-0" style="height:56px;text-decoration:none;">
                <div class="md-active-bg"></div>
            ...
            <a href="<?php echo e(route('home')); ?>#ods" class="md-nav-item flex items-center gap-4 px-4 py-0" style="height:56px;text-decoration:none;">
                <div class="md-active-bg"></div>
            ...
            <a href="<?php echo e(route('news.index')); ?>" data-nav-path="/noticias" class="md-nav-item flex items-center gap-4 px-4 py-0" style="height:56px;text-decoration:none;">
                <div class="md-active-bg"></div>
            ...
            <a href="<?php echo e(route('gallery.index')); ?>" data-nav-path="/galeria" class="md-nav-item flex items-center gap-4 px-4 py-0" style="height:56px;text-decoration:none;">
                <div class="md-active-bg"></div>
            ...
            <a href="<?php echo e(route('home')); ?>#contato" class="md-nav-item flex items-center gap-4 px-4 py-0" style="height:56px;text-decoration:none;">
                <div class="md-active-bg"></div>
        ...
        <div style="padding:12px 20px calc(12px + env(safe-area-inset-bottom,0px));border-top:1px solid #e5e7eb;display:flex;align-items:center;justify-content:space-between;">
            <p style="font-size:11px;color:#9ca3af;">© <?php echo e(date('Y')); ?> ISSM</p>
            <?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('admin.dashboard')); ?>" style="font-size:11px;color:#15803d;font-weight:600;text-decoration:none;">Painel Admin</a>
            <?php endif; ?>
        </div>
    </div>
    ...
    <footer class="bg-green-900 text-white" id="main-footer" style="border:none;outline:none;margin:0;">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div class="md:col-span-2">
                    <div class="flex items-center gap-3 mb-4">
                        <?php if($siteLogo ?? \App\Models\Setting::get('site_logo')): ?>
                        <img src="<?php echo e(asset('media/' . ($siteLogo ?? \App\Models\Setting::get('site_logo')))); ?>" alt="ISSM" class="h-12 w-auto object-contain">
                        <?php else: ?>
                    ...
                    <div class="flex gap-3">
                        <?php $facebook = \App\Models\Setting::get('social_facebook'); $instagram = \App\Models\Setting::get('social_instagram'); $youtube = \App\Models\Setting::get('social_youtube'); ?>
                        <?php if($facebook): ?><a href="<?php echo e($facebook); ?>" target="_blank" class="w-9 h-9 bg-green-700 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors" title="Facebook"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg></a><?php endif; ?>
                        <?php if($instagram): ?><a href="<?php echo e($instagram); ?>" target="_blank" class="w-9 h-9 bg-green-700 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors" title="Instagram"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg></a><?php endif; ?>
                        <?php if($youtube): ?><a href="<?php echo e($youtube); ?>" target="_blank" class="w-9 h-9 bg-green-700 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors" title="YouTube"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg></a><?php endif; ?>
                    </div>
                </div>
                <div>
                    <h4 class="font-semibold text-white mb-4">Links Rápidos</h4>
                    <ul class="space-y-2 text-green-200 text-sm">
                        <li><a href="<?php echo e(route('home')); ?>#sobre" class="hover:text-white transition-colors">Sobre o ISSM</a></li>
                        <li><a href="<?php echo e(route('projects.index')); ?>" class="hover:text-white transition-colors">Nossos Projetos</a></li>
                        <li><a href="<?php echo e(route('home')); ?>#ods" class="hover:text-white transition-colors">ODS 2030</a></li>
                        <li><a href="<?php echo e(route('news.index')); ?>" class="hover:text-white transition-colors">Notícias</a></li>
                        <li><a href="<?php echo e(route('gallery.index')); ?>" class="hover:text-white transition-colors">Galeria</a></li>
                        <li><a href="<?php echo e(route('home')); ?>#equipe" class="hover:text-white transition-colors">Nossa Equipe</a></li>
                        <li><a href="<?php echo e(route('home')); ?>#contato" class="hover:text-white transition-colors">Contato</a></li>
                    </ul>
                </div>
                <div>
                    <h4 class="font-semibold text-white mb-4">Contato</h4>
                    <ul class="space-y-2 text-green-200 text-sm">
                        <?php $email = \App\Models\Setting::get('contact_email'); $phone = \App\Models\Setting::get('contact_phone'); $address = \App\Models\Setting::get('contact_address'); ?>
                        <?php if($email): ?><li class="flex items-center gap-2"><svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg><?php echo e($email); ?></li><?php endif; ?>
                        <?php if($phone): ?><li class="flex items-center gap-2"><svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg><?php echo e($phone); ?></li><?php endif; ?>
                        <?php if($address): ?><li class="flex items-start gap-2"><svg class="w-4 h-4 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg><?php echo e($address); ?></li><?php endif; ?>
                    </ul>
                </div>
            </div>
        </div>
        <div class="border-t border-green-800">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row justify-between items-center gap-2">
                <p class="text-green-300 text-sm">&copy; <?php echo e(date('Y')); ?> ISSM - Instituto Socioambiental Serra do Mendanha. Todos os direitos reservados.</p>
                <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-green-400 hover:text-white text-sm transition-colors">Painel Admin</a>
                <?php endif; ?>
            </div>
        </div>
    </footer>
    ...
    <?php $supportMembers = \App\Models\TeamMember::where('support_active', true)->where('active', true)->orderBy('order')->get(); ?>
    <?php if($supportMembers->count() > 0): ?>
    <style>
    ...
    <div id="sup-widget">
        ...
        <div id="sup-box">
            ...
            <div class="sup-members">
                <?php $__currentLoopData = $supportMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="sup-member">
                    <?php if($sm->photo): ?>
                    <img src="<?php echo e(asset('media/'.$sm->photo)); ?>" alt="<?php echo e($sm->name); ?>" class="sup-avatar">
                    <?php else: ?>
                    <div class="sup-avatar-placeholder"><?php echo e(strtoupper(mb_substr($sm->name,0,1))); ?></div>
                    <?php endif; ?>
                    <div class="sup-info">
                        <p class="sup-name"><?php echo e($sm->name); ?></p>
                        <p class="sup-role"><?php echo e($sm->role); ?></p>
                    </div>
                    <div class="sup-actions">
                        <?php if($sm->whatsapp): ?>
                        <?php $wa = preg_replace('/\D/', '', $sm->whatsapp); ?>
                        <a href="https://wa.me/55<?php echo e($wa); ?>" target="_blank" rel="noopener" title="WhatsApp de <?php echo e($sm->name); ?>" class="sup-action-btn sup-wa">
                        ...
                        <?php endif; ?>
                        <?php if($sm->phone_support): ?>
                        <a href="tel:<?php echo e(preg_replace('/\D/', '', $sm->phone_support)); ?>" title="Ligar para <?php echo e($sm->name); ?>" class="sup-action-btn sup-tel">
        ...
        <button id="sup-fab" title="Suporte ISSM" aria-label="Abrir suporte">
            ...
            <span class="sup-badge"><?php echo e($supportMembers->count()); ?></span>
        </button>
    </div>
    <?php endif; ?>
    ...
    <nav id="bottom-nav"
        ...
        <div style="display:grid;grid-template-columns:repeat(5,1fr);height:64px;">
            ...
            <a href="<?php echo e(route('home')); ?>" data-nav-path="/"
            ...
            <a href="<?php echo e(route('projects.index')); ?>" data-nav-path="/projetos"
               class="nav-item flex flex-col items-center justify-center gap-0.5 text-gray-500" style="text-decoration:none;">
                <div class="nav-pill"></div>
            ...
            <a href="<?php echo e(route('home')); ?>#contato"
            ...
            <a href="<?php echo e(route('news.index')); ?>" data-nav-path="/noticias"
               class="nav-item flex flex-col items-center justify-center gap-0.5 text-gray-500" style="text-decoration:none;">
                <div class="nav-pill"></div>
...
<?php /**PATH /home/issmorg/public_html/resources/views/layouts/app.blade.php ENDPATH**/ ?>